...
// for(let i = 0; i <= arr.length; i++){
//         if(arr[i]===4){
//             console.log(`On ${i} index is ${arr[i]}`);
//         }
// }
...
// for(let i of arr){
//     if(i.indexOf('1') === 0 || i.indexOf('2') === 0 || i.indexOf('5') === 0 ){
//         console.log(i);
//     }
...
// let num;
// do{
//   num = prompt('Enter a number biger then 100');
...
// do {
//   num = prompt(`Enter a number from ${min} to ${max}`);
...
// let min = 12;
// let max = 41;
// let num = prompt(`Enter a number from ${min} to ${max}`);
